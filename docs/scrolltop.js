var scrolltotop = {
  ...
  controlHTML:
    '<button class="btn icon icon-shape btn-primary text-white rounded-circle shadow"><i class="fas fa-angle-up"></i></button>', //HTML for control, which is auto wrapped in DIV w/ ID="topcontrol"
